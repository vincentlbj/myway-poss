  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
		  <button type="button" onclick="location.href='<%=request.getContextPath()%>/exposure/insert'" class="btn btn-success">新增曝光台文章</button>
          <h2 class="sub-header">曝光台列表</h2>
          <div class="table-responsive">
            <table class="table table-striped">
              ...
              <tbody>
              	<c:forEach items="${exposureList}" var="exposure">
              		<tr>
              			<td>${exposure.title }</td>
              			<td>
              				<div class="btn-group" role="group" aria-label="...">
  								<button type="button" onclick="deleteItem(${exposure.id});" class="btn btn-danger">删除</button>
							</div>
						</td>
              		</tr>
              	</c:forEach>
    ...
    <script type="text/javascript">
    	function deleteItem(id){
    		...
    		if(flag==true){
    			location.href='<%=request.getContextPath()%>/exposure/delete/'+id;
    		}
    	}
    </script>
  </body>
