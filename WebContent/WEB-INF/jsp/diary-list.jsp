  ...
  <body>
              		...
              		<tr>
              			...
              			<td>
              				<div class="btn-group" role="group" aria-label="...">
  								<button type="button" onclick="location.href='<%=request.getContextPath()%>/diary/detail/${diary.dId }'" class="btn btn-info">查看</button>
  								<button type="button" onclick="deleteItem(${diary.dId});" class="btn btn-danger">删除</button>
							</div>
						</td>
              		</tr>
              	</c:forEach>
    ...
    <script type="text/javascript">
    	function deleteItem(id){
    		...
    		if(flag==true){
    			location.href='<%=request.getContextPath()%>/diary/delete/'+id;
    		}
    	}
    </script>
  </body>
