  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
		  <button type="button" onclick="location.href='<%=request.getContextPath()%>/ticket/insert'" class="btn btn-success">新增门票</button>
          <h2 class="sub-header">门票列表</h2>
              		...
              		<tr>
              			...
              			<td>
              				<div class="btn-group" role="group" aria-label="...">
  								<button type="button" onclick="location.href='<%=request.getContextPath()%>/ticket/edit/${ticket.id }'" class="btn btn-info">编辑</button>
  								<button type="button" onclick="deleteItem(${ticket.id});" class="btn btn-danger">删除</button>
							</div>
						</td>
              		</tr>
              	</c:forEach>
    ...
    <script type="text/javascript">
    	function deleteItem(id){
    		...
    		if(flag==true){
    			location.href='<%=request.getContextPath()%>/ticket/delete/'+id;
    		}
    	}
    </script>
  </body>
