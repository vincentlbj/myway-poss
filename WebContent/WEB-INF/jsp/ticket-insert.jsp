    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h2 class="sub-header">门票详情</h2>
          <form class="form-horizontal" role="form" id="form" action="<%=request.getContextPath()%>/ticket/insertSubmit" method="post">
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-10">
			      <textarea class="form-control" id="bookNotice" name="bookNotice" rows="5"></textarea>
			    </div>
			  </div>
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-10">
			      <textarea class="form-control" id="spotSummary" name="spotSummary" rows="5"></textarea>
			    </div>
			  </div>
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-10">
			      <textarea class="form-control" id="trafficMessage" name="trafficMessage" rows="5"></textarea>
			    </div>
			  </div>
